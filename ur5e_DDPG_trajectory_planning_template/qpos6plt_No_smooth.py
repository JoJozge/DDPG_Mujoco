...
jsp_path = 'M:/ur5e_DDPG_trajectory_planning_20000csv/joint_path_csv/'
est_path = './'
...
# 读取表格
step_list, yplt_list_qpos0, yplt_list_qpos1, yplt_list_qpos2, yplt_list_qpos3, yplt_list_qpos4, yplt_list_qpos5, total_reward = JSP.read_csv(k=k, type=0)  # 读取smooth前的六个关节角转动表
